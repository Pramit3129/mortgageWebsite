...
const sidebarNav = [
  { label: "Benefits of a Professional", href: "/mortgages/benefits", icon: Shield, active: true },
  ...
  return (
    <div className="min-h-svh w-full bg-background text-foreground">
      ...
      <section className="relative w-full h-[60vh] sm:h-[70vh] lg:h-[80vh] overflow-hidden">
        <Image
          src="/BenefitOfUsingMortgage.webp"
          alt="Benefits of using a mortgage professional"
          fill
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="max-w-7xl mx-auto w-full px-5 sm:px-6 lg:px-12 pb-14 lg:pb-24">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-serif font-extrabold text-foreground leading-[0.95] tracking-[-0.02em] mb-6 max-w-3xl">
              Why Use a{" "}
              <span className="italic font-light text-accent">Mortgage Professional.</span>
            </h1>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            ...
            <div className="lg:col-span-9 space-y-16 sm:space-y-20">
              ...
              {/* Opening paragraph */}
              <p className="text-foreground/80 text-base lg:text-lg font-light leading-[1.8] max-w-3xl">
              ...
              <div className="w-full">
                <div className="relative w-full overflow-hidden bg-card border border-white/[0.06]" style={{ paddingBottom: "56.25%" }}>
                  <iframe
                    src="https://www.youtube.com/embed/i3Z27c06WAQ"
                    title="Why Use a Mortgage Professional"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            <div className="lg:col-span-7">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-extrabold text-foreground leading-[1.05] tracking-[-0.02em] mb-6">
                Ready to work with{" "}
                <span className="italic font-light text-accent">a professional?</span>
              </h2>
              <p className="text-muted-foreground/60 text-base font-light leading-relaxed max-w-lg">
                Get expert, unbiased advice tailored to your unique financial situation. Your best mortgage starts with a conversation.
              </p>
            </div>
